 ...
 *   - Replaces _ with ' (restores apostrophes mangled during SQLite export)
...
function titleToFilename(raw) {
  return raw
    .trim()
    .replace(/_/g, "'")        // restore apostrophes mangled during SQLite export
    .replace(/:/g, '')         // strip colons (Mac-illegal)
    .replace(/\//g, '')        // strip forward slashes (Mac-illegal)
